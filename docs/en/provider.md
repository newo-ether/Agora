...
Agora includes configurations for OpenAI, Anthropic, Google Gemini, DeepSeek, DashScope/Qwen, OpenRouter, Requesty, OpenCode Go, Groq, Ollama, and Local models. Provider catalogs and endpoint behavior can change independently of the app.
